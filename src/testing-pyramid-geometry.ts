 ...
 */
export function tierGapPx(bandHeight: number): number {
 ...
 */
export function tierCornerRadius(bandWidth: number, tierHeight: number): number {
  return Math.min(
    Math.min(bandWidth / 2, tierHeight / 2),
