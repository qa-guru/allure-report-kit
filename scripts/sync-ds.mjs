...
const FILES = [
  ...
  "css/badge.css",
  "css/sparkline.css",
  "css/stability-cell.css",
  "css/tests-table-panel.css",
  "css/header.css",
...
function scopeTokensToHeader(content) {
  ...
  return [
    ...
    "",
    "/* Focus SSOT — scoped to the report header (host keeps its own rings). */",
    "#app-header {",
    ...
    "}",
    "html[data-keyboard-intent] #app-header :focus-visible {",
    "  outline: 2px solid var(--color-primary) !important;",
    "}",
    "#app-header button::-moz-focus-inner {",
    "  border: 0;",
    "}",
    "#app-header button,",
    '#app-header [type="button"],',
    '#app-header [type="submit"],',
    '#app-header [type="reset"],',
