/* Upstream `getChartWidgetByType` from @allurereport/web-dashboard, moved out
 * verbatim. In the fork this is the `stock` renderer path: every tile the kit
 * does not claim is still drawn by Allure own widget.
 */
...
export const getChartWidgetByType = (
